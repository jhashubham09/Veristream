...
async function handler(req, res) {
    if (req.method === "POST") {
        try {
            ...
            const videoFilePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(tempDir, videoFileName);
            console.log("Downloading video...");
            // 1. Download the video using yt-dlp
            await new Promise((resolve, reject)=>{
                const downloadProcess = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])("yt-dlp", [
                    "-o",
                    videoFilePath,
                    videoUrl
                ]);
                downloadProcess.on("close", (code)=>{
                    if (code !== 0) {
                        console.error("yt-dlp failed to download video.");
            ...
            const whisperOutputFile = `${videoFilePath}.json`;
            await new Promise((resolve, reject)=>{
                ...
                whisperProcess.on("close", (code)=>{
                    if (code !== 0) {
                        console.error("Whisper failed to transcribe video.");
                        return reject(new Error("Failed to transcribe video"));
                    }
                    console.log("Whisper transcription completed:", whisperOutputFile);
                    resolve();
                });
            });
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].unlinkSync(videoFilePath);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ae8dcb._.js.map