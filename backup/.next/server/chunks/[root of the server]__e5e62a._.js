...
(()=>{
    const e = new Error("Cannot find module 'ytdl-core'");
...
async function downloadVideo(videoUrl, outputPath) {
    try {
        ...
        if (videoUrl.includes('youtu.be') || videoUrl.includes('youtube.com')) {
            // Download using ytdl-core for YouTube videos
        ...
        // For non-YouTube URLs, use the existing axios implementation
        // ... (keep your existing axios implementation here)
        }
    } catch (error) {
...
async function transcribeVideo(videoPath) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        const pythonProcess = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])('python', [
            ...
            // Add these options to ensure proper Python environment
            env: {
                ...process.env,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e5e62a._.js.map